...
"""change made"""
#All caching logic (past_key_values, cache_position, use_cache) 
# is specific to decoders and autoregressive generation. 
# Removing them simplifies the forward pass for encoder-only use.
    ...
    @staticmethod
"""change made"""
##This class wraps the Phi4MMModel with a causal LM head. 
# It assumes a decoder that predicts next tokens and uses caching, past key values, and the generate method
